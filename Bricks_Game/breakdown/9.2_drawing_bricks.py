#Task1: You have created the bricks list in your last assignment.
#Now, Draw all the bricks to the screen using a for loop. Loop through every brick in the bricks list and draw each brick.
